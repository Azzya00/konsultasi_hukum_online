...
<body>
    <div class="header">
        ...
        <div class="title">Kontrak Vendor</div>
    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Pastikan penyusunan kontrak antara Anda dan vendor dalam Sewa Menyewa, Jual Beli, Jasa Konsultan IT, Psikologi, dan lainnya, telah memuat hak dan kewajiban yang sesuai dengan kebutuhan Anda.</p>
            </div>
            ...
            <div class="parties">
                <div class="party">
                    ...
                    <div class="advokat-list">
                        <?php
                        $result = $conn->query("SELECT * FROM advokat WHERE keahlian LIKE '%Bisnis%'");
