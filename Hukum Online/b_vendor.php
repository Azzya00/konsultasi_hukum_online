...
// Ambil ID Layanan 'Kemitraan Vendor/Bisnis' dari database
$layanan_vendor_query = $conn->query("SELECT id FROM layanan WHERE nama_layanan = 'Kemitraan Vendor/Bisnis' LIMIT 1"); // <<< GANTI SESUAI NAMA DI DATABASE
$layanan_id_vendor = 0;
if ($layanan_vendor_query && $layanan_vendor_query->num_rows > 0) {
    $layanan_id_vendor = $layanan_vendor_query->fetch_assoc()['id'];
}
...
if ($layanan_id_vendor == 0) {
    error_log("Layanan 'Kemitraan Vendor/Bisnis' tidak ditemukan di database.");
}
...
<head>
    ...
    <title>SaifulMLaw - Kemitraan Vendor/Bisnis</title>
    <style>
...
<div class="container">
    <div class="main-content">
        <div class="doc-header">
            <h1 class="doc-title">Kemitraan Vendor / Bisnis</h1>
            <p class="doc-subtitle">Solusi hukum terintegrasi untuk kebutuhan kemitraan dan bisnis Anda.</p>
        </div>
        ...
        <div class="case-info">
            ...
            <div class="case-details">
                <div class="detail-item">
                    ...
                    <div class="detail-value">Pendampingan Hukum untuk Kemitraan dan Bisnis</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Tujuan</div>
                    <div class="detail-value">Membantu menyusun perjanjian yang adil dan melindungi kepentingan semua pihak.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Cakupan</div>
                    <div class="detail-value">Review kontrak, negosiasi, mediasi sengketa bisnis, dll.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Durasi Layanan</div>
                    <div class="detail-value">Sesuai kebutuhan atau perjanjian retainer.</div>
                </div>
            </div>
        </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <div class="detail-label">Analisis Kebutuhan Kemitraan</div>
                    <div class="detail-value">Diskusikan tujuan dan struktur kemitraan atau bisnis yang Anda inginkan.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">2</div>
                <div class="timeline-content">
                    <div class="detail-label">Penyusunan/Review Kontrak Bisnis</div>
                    <div class="detail-value">Kami akan menyusun atau mereview kontrak yang terkait dengan kemitraan vendor/bisnis Anda.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">3</div>
                <div class="timeline-content">
                    <div class="detail-label">Negosiasi & Mediasi (jika diperlukan)</div>
                    <div class="detail-value">Mendampingi dalam proses negosiasi atau mediasi untuk mencapai kesepakatan terbaik.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">4</div>
                <div class="timeline-content">
                    <div class="detail-label">Dukungan Hukum Berkelanjutan</div>
                    <div class="detail-value">Memberikan konsultasi dan dukungan hukum berkelanjutan untuk operasional bisnis.</div>
                </div>
            </div>
        </div>
    ...
    <div class="sidebar">
        <div class="sidebar-card">
            <div class="price-info">
                ...
                <p class="price">Rp. 1.500.000</p> <p class="consultation-info">Harga dapat bervariasi tergantung kompleksitas layanan.</p>
            </div>
            <?php if ($advokat_id_contoh > 0 && $layanan_id_vendor > 0): ?>
                <a href="pembayaran.php?advokat_id=<?= htmlspecialchars($advokat_id_contoh) ?>&layanan_id=<?= htmlspecialchars($layanan_id_vendor) ?>" class="pesan-dokumen-btn">
                    Pesan Layanan Ini
                </a>
            <?php else: ?>
        ...
        <div class="sidebar-card">
            ...
            <ul class="related-links">
                ...
                <li><a href="u_dokumen.php">Pembuatan Dokumen Hukum</a></li>
                <li><a href="b_retainer.php">Jasa Retainer</a></li>
