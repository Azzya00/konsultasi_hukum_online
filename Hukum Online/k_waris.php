...
// Ambil ID Layanan 'Gugatan Waris' dari database
$layanan_waris_query = $conn->query("SELECT id FROM layanan WHERE nama_layanan = 'Gugatan Waris' LIMIT 1"); // <<< GANTI SESUAI NAMA DI DATABASE
$layanan_id_waris = 0;
if ($layanan_waris_query && $layanan_waris_query->num_rows > 0) {
    $layanan_id_waris = $layanan_waris_query->fetch_assoc()['id'];
}
...
if ($layanan_id_waris == 0) {
    error_log("Layanan 'Gugatan Waris' tidak ditemukan di database.");
}
...
<head>
    ...
    <title>SaifulMLaw - Gugatan Waris</title>
    <style>
...
<div class="container">
    <div class="main-content">
        <div class="doc-header">
            <h1 class="doc-title">Gugatan Waris</h1>
            <p class="doc-subtitle">Dapatkan keadilan dalam pembagian warisan dengan bantuan ahli hukum.</p>
        </div>
        ...
        <div class="case-info">
            ...
            <div class="case-details">
                <div class="detail-item">
                    ...
                    <div class="detail-value">Pengajuan dan Pendampingan Gugatan Waris</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Tujuan</div>
                    <div class="detail-value">Memastikan pembagian warisan sesuai hukum yang berlaku dan keadilan bagi ahli waris.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Cakupan</div>
                    <div class="detail-value">Penyusunan dokumen, pendaftaran, mediasi, hingga persidangan.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Waktu Proses</div>
                    <div class="detail-value">Bervariasi tergantung kompleksitas sengketa dan jadwal pengadilan.</div>
                </div>
            </div>
        </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <div class="detail-label">Analisis Kasus & Data Waris</div>
                    <div class="detail-value">Kumpulkan dokumen terkait ahli waris, harta peninggalan, dan wasiat (jika ada).</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">2</div>
                <div class="timeline-content">
                    <div class="detail-label">Penyusunan & Pendaftaran Gugatan</div>
                    <div class="detail-value">Kami akan menyusun gugatan waris dan mendaftarkannya ke pengadilan yang berwenang.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">3</div>
                <div class="timeline-content">
                    <div class="detail-label">Pendampingan Proses Hukum</div>
                    <div class="detail-value">Pendampingan di setiap tahap persidangan, termasuk mediasi dan pembuktian.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">4</div>
                <div class="timeline-content">
                    <div class="detail-label">Eksekusi Putusan</div>
                    <div class="detail-value">Membantu proses eksekusi putusan pengadilan terkait pembagian warisan.</div>
                </div>
            </div>
        </div>
    ...
    <div class="sidebar">
        <div class="sidebar-card">
            <div class="price-info">
                ...
                <p class="price">Rp. 1.500.000</p> <p class="consultation-info">Harga dapat bervariasi tergantung kompleksitas sengketa waris.</p>
            </div>
            <?php if ($advokat_id_contoh > 0 && $layanan_id_waris > 0): ?>
                <a href="pembayaran.php?advokat_id=<?= htmlspecialchars($advokat_id_contoh) ?>&layanan_id=<?= htmlspecialchars($layanan_id_waris) ?>" class="pesan-dokumen-btn">
                    Pesan Layanan Ini
                </a>
            <?php else: ?>
        ...
        <div class="sidebar-card">
            ...
            <ul class="related-links">
                <li><a href="k_wasiat.php">Pembuatan Wasiat</a></li>
