    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Dapatkan saran yang rinci melalui konsultasi dan pengecekan detail hak waris</p>
            </div>
            ...
            <div class="parties">
                <div class="party">
                    ...
                    <div class="advokat-list">
                        <?php
                        $result = $conn->query("SELECT * FROM advokat WHERE keahlian LIKE '%Waris%'");
