...
<body>
    <div class="header">
        ...
        <div class="title">Review Dokumen Hukum</div>
    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Baca, pahami baru tanda tangani. Memastikan dokumen hukum Anda telah memuat segala hak dan kewajiban yang sesuai. Dengan memberikan saran-saran perbaikan dokumen.</p>
            </div>
