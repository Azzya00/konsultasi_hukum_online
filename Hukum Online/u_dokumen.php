...
// Ambil ID Layanan 'Pembuatan Dokumen Hukum' dari database
$layanan_dokumen_query = $conn->query("SELECT id FROM layanan WHERE nama_layanan = 'Pembuatan Dokumen Hukum' LIMIT 1"); // <<< GANTI SESUAI NAMA DI DATABASE
$layanan_id_dokumen = 0;
if ($layanan_dokumen_query && $layanan_dokumen_query->num_rows > 0) {
    $layanan_id_dokumen = $layanan_dokumen_query->fetch_assoc()['id'];
}
...
if ($layanan_id_dokumen == 0) {
    error_log("Layanan 'Pembuatan Dokumen Hukum' tidak ditemukan di database.");
}
...
<head>
    ...
    <title>SaifulMLaw - Pembuatan Dokumen Hukum</title>
    <style>
...
<div class="container">
    <div class="main-content">
        <div class="doc-header">
            <h1 class="doc-title">Pembuatan Dokumen Hukum</h1>
            <p class="doc-subtitle">Siapkan berbagai dokumen hukum dengan presisi dan keabsahan.</p>
        </div>
        ...
        <div class="case-info">
            ...
            <div class="case-details">
                <div class="detail-item">
                    ...
                    <div class="detail-value">Pembuatan Surat Kuasa, Surat Perjanjian, dll.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Tujuan</div>
                    <div class="detail-value">Membuat dokumen hukum yang sesuai standar dan melindungi kepentingan Anda.</div>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">Estimasi 1-3 hari kerja tergantung kompleksitas dokumen.</div>
                </div>
            </div>
        </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <div class="detail-label">Sampaikan Kebutuhan Dokumen Anda</div>
                    <div class="detail-value">Jelaskan dokumen hukum apa yang Anda butuhkan dan tujuannya.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">2</div>
                <div class="timeline-content">
                    <div class="detail-label">Pengumpulan Data & Informasi</div>
                    <div class="detail-value">Kami akan mengumpulkan semua data dan informasi yang diperlukan untuk penyusunan dokumen.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">3</div>
                <div class="timeline-content">
                    <div class="detail-label">Penyusunan Draf Dokumen</div>
                    <div class="detail-value">Tim advokat akan menyusun draf dokumen sesuai standar hukum dan kebutuhan Anda.</div>
                </div>
            </div>
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    ...
                    <div class="detail-value">Draf akan direview bersama Anda, lalu difinalisasi dan diserahkan.</div>
                </div>
            </div>
        </div>
    ...
    <div class="sidebar">
        <div class="sidebar-card">
            <div class="price-info">
                ...
                <p class="price">Rp. 1.500.000</p> <p class="consultation-info">Harga dapat bervariasi tergantung jenis dokumen.</p>
            </div>
            <?php if ($advokat_id_contoh > 0 && $layanan_id_dokumen > 0): ?>
                <a href="pembayaran.php?advokat_id=<?= htmlspecialchars($advokat_id_contoh) ?>&layanan_id=<?= htmlspecialchars($layanan_id_dokumen) ?>" class="pesan-dokumen-btn">
                    Pesan Layanan Ini
                </a>
            <?php else: ?>
