...
<body>
    <div class="header">
        ...
        <div class="title">Kontrak Ketenagakerjaan</div>
    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Kontrak ketenagakerjaan adalah kontrak antara pekerja/buruh dengan pengusaha atau pemberi kerja yang memuat syarat kerja, hak, dan kewajiban para pihak.</p>
            </div>
