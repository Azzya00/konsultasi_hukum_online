...
<body>
    <div class="header">
        ...
        <div class="title">Pembuatan Surat Somasi</div>
    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Merupakan jasa pembuatan surat peringatan atau teguran yang ditujukan kepada pihak yang merugikan Anda, yang berisi permintaan untuk: menyerahkan sesuatu yang telah dijanjikan, melakukan suatu perbuatan, atau tidak melakukan suatu perbuatan.</p>
            </div>
