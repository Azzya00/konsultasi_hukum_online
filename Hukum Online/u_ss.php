...
// Ambil ID Layanan 'Pembuatan Gugatan/Surat' dari database
$layanan_gugatan_query = $conn->query("SELECT id FROM layanan WHERE nama_layanan = 'Pembuatan Gugatan/Surat' LIMIT 1"); // <<< GANTI SESUAI NAMA DI DATABASE
$layanan_id_gugatan = 0;
if ($layanan_gugatan_query && $layanan_gugatan_query->num_rows > 0) {
    $layanan_id_gugatan = $layanan_gugatan_query->fetch_assoc()['id'];
}
...
if ($layanan_id_gugatan == 0) {
    error_log("Layanan 'Pembuatan Gugatan/Surat' tidak ditemukan di database.");
}
...
<head>
    ...
    <title>SaifulMLaw - Pembuatan Gugatan / Surat Penting</title>
    <style>
...
<div class="container">
    <div class="main-content">
        <div class="doc-header">
            <h1 class="doc-title">Pembuatan Surat Somasi</h1>
            <p class="doc-subtitle">Dapatkan bantuan dalam penyusunan gugatan atau surat-surat resmi lainnya.</p>
        </div>
        ...
        <div class="case-info">
            ...
            <div class="case-details">
                <div class="detail-item">
                    ...
                    <div class="detail-value">Penyusunan Surat Gugatan, Somasi, dan lainnya.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Tujuan</div>
                    <div class="detail-value">Menyajikan kasus Anda secara tertulis dengan argumen hukum yang kuat.</div>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">Estimasi 3-7 hari kerja tergantung kompleksitas kasus.</div>
                </div>
            </div>
        </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <div class="detail-label">Sampaikan Detail Kasus</div>
                    <div class="detail-value">Berikan semua informasi yang relevan terkait gugatan atau surat yang akan dibuat.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">2</div>
                <div class="timeline-content">
                    <div class="detail-label">Analisis Hukum & Strategi</div>
                    <div class="detail-value">Tim advokat akan menganalisis kasus Anda dan merumuskan strategi penulisan yang efektif.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">3</div>
                <div class="timeline-content">
                    <div class="detail-label">Penyusunan Draf Gugatan/Surat</div>
                    <div class="detail-value">Draf dokumen akan disusun dengan cermat sesuai kaidah hukum yang berlaku.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">4</div>
                <div class="timeline-content">
                    <div class="detail-label">Review Bersama & Finalisasi</div>
                    <div class="detail-value">Anda akan diajak mereview draf sebelum finalisasi dan penyerahan dokumen.</div>
                </div>
            </div>
        </div>
    ...
    <div class="sidebar">
        <div class="sidebar-card">
            <div class="price-info">
                ...
                <p class="price">Rp. 1.500.000</p> <p class="consultation-info">Harga dapat bervariasi tergantung jenis dan kompleksitas dokumen.</p>
            </div>
            <?php if ($advokat_id_contoh > 0 && $layanan_id_gugatan > 0): ?>
                <a href="pembayaran.php?advokat_id=<?= htmlspecialchars($advokat_id_contoh) ?>&layanan_id=<?= htmlspecialchars($layanan_id_gugatan) ?>" class="pesan-dokumen-btn">
                    Pesan Layanan Ini
                </a>
            <?php else: ?>
