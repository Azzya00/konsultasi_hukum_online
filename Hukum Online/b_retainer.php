...
// Ambil ID Layanan 'Jasa Retainer' dari database
$layanan_retainer_query = $conn->query("SELECT id FROM layanan WHERE nama_layanan = 'Jasa Retainer' LIMIT 1"); // <<< GANTI SESUAI NAMA DI DATABASE
$layanan_id_retainer = 0;
if ($layanan_retainer_query && $layanan_retainer_query->num_rows > 0) {
    $layanan_id_retainer = $layanan_retainer_query->fetch_assoc()['id'];
}
...
if ($layanan_id_retainer == 0) {
    error_log("Layanan 'Jasa Retainer' tidak ditemukan di database.");
}
...
<head>
    ...
    <title>SaifulMLaw - Jasa Retainer</title>
    <style>
...
<div class="container">
    <div class="main-content">
        <div class="doc-header">
            <h1 class="doc-title">Jasa Retainer (Langganan Hukum)</h1>
            <p class="doc-subtitle">Dapatkan dukungan hukum berkelanjutan untuk bisnis atau kebutuhan pribadi Anda.</p>
        </div>
        ...
        <div class="case-info">
            ...
            <div class="case-details">
                <div class="detail-item">
                    ...
                    <div class="detail-value">Konsultasi reguler, review dokumen, pendampingan ringan.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Tujuan</div>
                    <div class="detail-value">Memberikan akses mudah dan cepat ke bantuan hukum untuk kebutuhan sehari-hari.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Cakupan</div>
                    <div class="detail-value">Sesuai perjanjian retainer bulanan/tahunan.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Durasi</div>
                    <div class="detail-value">Bulanan/Tahunan (fleksibel).</div>
                </div>
            </div>
        </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <div class="detail-label">Pilih Paket Retainer</div>
                    <div class="detail-value">Pilih paket retainer yang sesuai dengan kebutuhan hukum Anda.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">2</div>
                <div class="timeline-content">
                    <div class="detail-label">Perjanjian & Aktivasi</div>
                    <div class="detail-value">Tanda tangani perjanjian retainer dan layanan Anda akan segera aktif.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">3</div>
                <div class="timeline-content">
                    <div class="detail-label">Akses Mudah ke Advokat</div>
                    <div class="detail-value">Dapatkan prioritas akses untuk konsultasi dan bantuan hukum kapan saja Anda butuhkan.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">4</div>
                <div class="timeline-content">
                    <div class="detail-label">Laporan & Evaluasi</div>
                    <div class="detail-value">Dapatkan laporan berkala tentang penggunaan layanan dan manfaat yang Anda peroleh.</div>
                </div>
            </div>
        </div>
    ...
    <div class="sidebar">
        <div class="sidebar-card">
            <div class="price-info">
                ...
                <p class="price">Rp. 1.500.000</p> <p class="consultation-info">Harga paket bulanan, tergantung cakupan layanan.</p>
            </div>
            <?php if ($advokat_id_contoh > 0 && $layanan_id_retainer > 0): ?>
                <a href="pembayaran.php?advokat_id=<?= htmlspecialchars($advokat_id_contoh) ?>&layanan_id=<?= htmlspecialchars($layanan_id_retainer) ?>" class="pesan-dokumen-btn">
                    Pesan Layanan Ini
                </a>
            <?php else: ?>
