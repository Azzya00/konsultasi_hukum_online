    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Dapatkan konsultan hukum berpengalaman yang terdedikasi khusus untuk perusahaan Anda</p>
            </div>
            ...
            <div class="parties">
                <div class="party">
                    ...
                    <div class="advokat-list">
                        <?php
                        $result = $conn->query("SELECT * FROM advokat WHERE keahlian LIKE '%Kekayaan Intelektual%'");
