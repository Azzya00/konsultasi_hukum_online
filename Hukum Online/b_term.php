...
<body>
    <div class="header">
        ...
        <div class="title">Ketentuan Layanan (Terms & Conditions)</div>
    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Penyusunan Syarat & Ketentuan Layanan, Kebijakan Privasi pelanggan untuk memudahkan kelangsungan bisnis.</p>
            </div>
