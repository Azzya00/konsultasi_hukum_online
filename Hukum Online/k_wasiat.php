...
// Ambil ID Layanan 'Pembuatan Wasiat' dari database
$layanan_wasiat_query = $conn->query("SELECT id FROM layanan WHERE nama_layanan = 'Pembuatan Wasiat' LIMIT 1"); // <<< GANTI SESUAI NAMA DI DATABASE
$layanan_id_wasiat = 0;
if ($layanan_wasiat_query && $layanan_wasiat_query->num_rows > 0) {
    $layanan_id_wasiat = $layanan_wasiat_query->fetch_assoc()['id'];
}
...
if ($layanan_id_wasiat == 0) {
    error_log("Layanan 'Pembuatan Wasiat' tidak ditemukan di database.");
}
...
<head>
    ...
    <title>SaifulMLaw - Pembuatan Wasiat & Perencanaan Waris</title>
    <style>
...
<div class="container">
    <div class="main-content">
        <div class="doc-header">
            <h1 class="doc-title">Pembuatan Wasiat & Perencanaan Waris</h1>
            <p class="doc-subtitle">Rencanakan masa depan aset Anda dengan wasiat yang sah dan terencana.</p>
        </div>
        ...
        <div class="case-info">
            ...
            <div class="case-details">
                <div class="detail-item">
                    ...
                    <div class="detail-value">Penyusunan Wasiat dan Dokumen Perencanaan Waris</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Tujuan</div>
                    <div class="detail-value">Memastikan pembagian harta sesuai keinginan Anda dan menghindari sengketa di masa depan.</div>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-value">Estimasi 3-7 hari kerja setelah data dan diskusi lengkap diterima.</div>
                </div>
            </div>
        </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <div class="detail-label">Konsultasi & Identifikasi Aset</div>
                    <div class="detail-value">Diskusikan keinginan Anda terkait pembagian warisan dan identifikasi semua aset.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">2</div>
                <div class="timeline-content">
                    <div class="detail-label">Pengumpulan Dokumen Pendukung</div>
                    <div class="detail-value">Siapkan dokumen kepemilikan aset, identitas ahli waris, dll.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">3</div>
                <div class="timeline-content">
                    <div class="detail-label">Penyusunan Draf Wasiat</div>
                    <div class="detail-value">Tim advokat akan menyusun draf wasiat sesuai keinginan Anda dan hukum yang berlaku.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">4</div>
                <div class="timeline-content">
                    <div class="detail-label">Finalisasi & Legalisasi</div>
                    <div class="detail-value">Wasiat akan difinalisasi dan, jika diperlukan, dibantu proses legalisasinya.</div>
                </div>
            </div>
        </div>
    ...
    <div class="sidebar">
        <div class="sidebar-card">
            <div class="price-info">
                ...
                <p class="price">Rp. 1.500.000</p> <p class="consultation-info">Harga dapat bervariasi tergantung kompleksitas warisan.</p>
            </div>
            <?php if ($advokat_id_contoh > 0 && $layanan_id_wasiat > 0): ?>
                <a href="pembayaran.php?advokat_id=<?= htmlspecialchars($advokat_id_contoh) ?>&layanan_id=<?= htmlspecialchars($layanan_id_wasiat) ?>" class="pesan-dokumen-btn">
                    Pesan Layanan Ini
                </a>
            <?php else: ?>
        ...
        <div class="sidebar-card">
            ...
            <ul class="related-links">
                <li><a href="k_waris.php">Gugatan Waris</a></li>
