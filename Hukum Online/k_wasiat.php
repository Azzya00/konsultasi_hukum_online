    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Persiapkan surat wasiat Anda untuk menjamin ketenangan keluarga</p>
            </div>
            ...
            <div class="parties">
                <div class="party">
                    ...
                    <div class="advokat-list">
                        <?php
                        $result = $conn->query("SELECT * FROM advokat WHERE keahlian LIKE '%Wasiat%'");
