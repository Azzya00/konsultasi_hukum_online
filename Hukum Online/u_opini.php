...
<body>
    <div class="header">
        ...
        <div class="title">Opini Hukum</div>
    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Dokumen hukum ini disiapkan dan akan digunakan dalam konteks urusan yang disebutkan dengan menggunakan, dan sesuai dengan hukum Indonesia selama yang berlaku saat ini</p>
            </div>
            ...
            <div class="case-info">
                ...
                <div class="case-details">
                    <div class="detail-item">
                        <div class="detail-label">Anak dalam syahrihan sah per takdir syarat yang telah dipat tetapi</div>
                    </div>
                    <div class="detail-item">
            ...
            <div class="parties">
                <div class="party">
                    ...
                    <div class="advokat-list">
                        <?php
                        $result = $conn->query("SELECT * FROM advokat WHERE keahlian LIKE '%Bisnis%' OR keahlian LIKE '%Pidana%' OR keahlian LIKE '%Keluarga%';");
