...
// Ambil ID Layanan 'Konsultasi Online' dari database
$layanan_konsultasi_query = $conn->query("SELECT id FROM layanan WHERE nama_layanan = 'Konsultasi Online' LIMIT 1"); // <<< GANTI SESUAI NAMA DI DATABASE
$layanan_id_konsultasi = 0;
if ($layanan_konsultasi_query && $layanan_konsultasi_query->num_rows > 0) {
    $layanan_id_konsultasi = $layanan_konsultasi_query->fetch_assoc()['id'];
}
...
if ($layanan_id_konsultasi == 0) {
    error_log("Layanan 'Konsultasi Online' tidak ditemukan di database.");
}
...
<head>
    ...
    <title>SaifulMLaw - Konsultasi Online</title>
    <style>
...
<div class="container">
    <div class="main-content">
        <div class="doc-header">
            <h1 class="doc-title">Pembuatan Jawaban Somasi</h1>
            <p class="doc-subtitle">Dapatkan nasihat hukum cepat dan efisien melalui chat atau telepon.</p>
        </div>
        ...
        <div class="case-info">
            ...
            <div class="case-details">
                <div class="detail-item">
                    ...
                    <div class="detail-value">Konsultasi via Chat dan/atau Telepon</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Tujuan</div>
                    <div class="detail-value">Menyediakan akses mudah ke advokat untuk pertanyaan hukum mendesak.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Format Konsultasi</div>
                    <div class="detail-value">Interaktif melalui platform chat atau panggilan telepon.</div>
                </div>
                <div class="detail-item">
                    <div class="detail-label">Durasi</div>
                    <div class="detail-value">Sesuai paket yang dipilih (misal: 30 menit, 1 jam).</div>
                </div>
            </div>
        </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content">
                    <div class="detail-label">Pilih Advokat & Jadwal</div>
                    <div class="detail-value">Pilih advokat yang tersedia dan tentukan waktu konsultasi Anda.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">2</div>
                <div class="timeline-content">
                    <div class="detail-label">Siapkan Pertanyaan Anda</div>
                    <div class="detail-value">Siapkan daftar pertanyaan atau detail kasus yang ingin Anda diskusikan.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">3</div>
                <div class="timeline-content">
                    <div class="detail-label">Sesi Konsultasi</div>
                    <div class="detail-value">Lakukan konsultasi langsung dengan advokat melalui chat atau telepon.</div>
                </div>
            </div>
            <div class="timeline-item">
                <div class="timeline-number">4</div>
                <div class="timeline-content">
                    <div class="detail-label">Ringkasan & Solusi</div>
                    <div class="detail-value">Dapatkan ringkasan konsultasi dan langkah-langkah selanjutnya yang direkomendasikan.</div>
                </div>
            </div>
        </div>
    ...
    <div class="sidebar">
        <div class="sidebar-card">
            <div class="price-info">
                ...
                <p class="price">Rp. 1.500.000</p> <p class="consultation-info">Harga per sesi, paket tersedia untuk durasi lebih panjang.</p>
            </div>
            <?php if ($advokat_id_contoh > 0 && $layanan_id_konsultasi > 0): ?>
                <a href="pembayaran.php?advokat_id=<?= htmlspecialchars($advokat_id_contoh) ?>&layanan_id=<?= htmlspecialchars($layanan_id_konsultasi) ?>" class="pesan-dokumen-btn">
                    Pesan Layanan Ini
                </a>
            <?php else: ?>
        ...
        <div class="sidebar-card">
            ...
            <ul class="related-links">
                ...
                <li><a href="u_kontrak.php">Analisis Kontrak</a></li>
