...
<body>
    <div class="header">
        ...
        <div class="title">Peraturan PerusahaanM</div>
    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Dokumen hukum yang dibuat secara tertulis oleh Perusahaan, yang di dalamnya memuat syarat-syarat kerja dan tata tertib perusahaan.</p>
            </div>
