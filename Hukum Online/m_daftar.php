...
<body>
    <div class="header">
        ...
        <div class="title">Pendaftaran Merek</div>
    ...
    <div class="container">
        <div class="main-content">
            <div class="doc-header">
                <p class="doc-subtitle">Pengurusan pendaftaran Merek ke DJKI KumHAM RI tidak hanya sebagai perlindungan dari peniruan dan/atau pembajakan, tapi juga merupakan investasi bagi rencana pengembangan karya dan/atau bisnis Anda kedepannya.</p>
            </div>
            ...
            <div class="parties">
                <div class="party">
                    ...
                    <div class="advokat-list">
                        <?php
                        $result = $conn->query("SELECT * FROM advokat WHERE keahlian LIKE '%Perdata%'");
